...
use Xolens\PgLaraenquery\App\Model\View\GroupParticipantView;
use Xolens\PgLaraenquery\App\Repository\GroupParticipantRepository;
use Xolens\PgLarautil\App\Repository\AbstractReadableRepository;
use Xolens\PgLarautil\App\Util\Model\Filterer;
use Xolens\PgLarautil\App\Util\Model\Sorter;

class GroupParticipantViewRepository extends AbstractReadableRepository implements GroupParticipantViewRepositoryContract
{
    public function model(){
        return GroupParticipantView::class;
    }
     public function paginateByGroup($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(GroupParticipant::GROUP_PROPERTY, $parentId);
