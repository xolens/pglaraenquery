...
use Xolens\PgLaraenquiry\App\Model\View\SectionFieldView;
use Xolens\PgLaraenquiry\App\Repository\SectionFieldRepository;
use Xolens\PgLarautil\App\Repository\AbstractReadableRepository;
use Xolens\PgLarautil\App\Util\Model\Filterer;
use Xolens\PgLarautil\App\Util\Model\Sorter;

class SectionFieldViewRepository extends AbstractReadableRepository implements SectionFieldViewRepositoryContract
{
    public function model(){
        return SectionFieldView::class;
    }
     public function paginateByField($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(SectionField::FIELD_PROPERTY, $parentId);
     ...
     public function paginateBySection($parentId, $perPage=50, $page = null,  $columns = ['*'], $pageName = 'page'){
        $parentFilterer = new Filterer();
        $parentFilterer->equals(SectionField::SECTION_PROPERTY, $parentId);
        return $this->paginateFiltered($parentFilterer, $perPage, $page,  $columns, $pageName);
     }
